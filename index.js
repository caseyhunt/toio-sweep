...
function sweep(){
  ...
  if (gCubes[0] != undefined){
      ...
      // console.log("x: " + xmove.toString(16) + " y: "+ ymove.toString(16));
      cube = gCubes[0];
      buf5= new Uint8Array([0x03, 0x00, 0xA, 0x02, 0xF, 0x00, 0x00,0x6d, 0x02, 0xe0, 0x00, 0x67, 0x01]);
...
let sweep = [[0x03, 0x00, 0xA, 0x00, 0xF, 0x00, 0x00,0x74, 0x01, 0xe0, 0x00, 0x67, 0x01], [0x03, 0x00, 0xA, 0x02, 0xF, 0x00, 0x00,0x77, 0x01, 0xc8, 0x00, 0x00, 0x00],  [0x03, 0x00, 0xA, 0x02, 0xF, 0x00, 0x00,0x5e,0x02, 0xc5, 0x00, 0x00, 0x00], [0x03, 0x00, 0xA, 0x02, 0xF, 0x00, 0x00,0x60, 0x02, 0xbb, 0x00, 0xb4, 0x00]];
